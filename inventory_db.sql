...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 01, 2025 at 09:11 AM
...
(97, 1, 'qwerty213', 'Registered staff', 'pierce valdez', '2025-11-30 13:29:11'),
(98, 1, 'qwerty213', 'Registered staff', 'pierce valdez', '2025-11-30 13:37:37'),
(99, 1, 'qwerty213', 'Registered staff', 'pierce valdez', '2025-11-30 13:53:06'),
(100, 1, 'qwerty213', 'Admin created invitation for harvey21@gmail.com', 'Sales Department', '2025-11-30 13:59:02'),
(101, 1, 'qwerty213', 'Added 10 units', 'Wmns Cortez', '2025-11-30 13:59:24'),
(102, 1, 'qwerty213', 'Deducted 15 units', 'Vans Men\'s Old Skool', '2025-11-30 16:08:41'),
(103, 3, 'qwerty', 'Deducted 1 units', 'Wmns Cortez', '2025-11-30 21:48:06'),
(104, 3, 'qwerty', 'Added 1 units', 'boots', '2025-11-30 21:48:17'),
(105, 3, 'qwerty', 'Staff edited product', 'boots', '2025-11-30 21:49:33'),
(106, 1, 'qwerty213', 'Registered staff', 'asdfgh zxcvbn', '2025-12-01 08:35:13');
...
(13, 'Gc48_niTHipAnha-tCgzut4X38osJrkbyjSceB6UCLE', 'harvey21@gmail.com', 'staff', 'Sales', 1, '2025-11-30 13:59:02', '2025-12-01 13:59:02', 0, NULL),
...
CREATE TABLE IF NOT EXISTS `login_activity` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM AUTO_INCREMENT=362 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(307, 1, 'qwerty213', 'Logout', '2025-11-30 12:26:17', '127.0.0.1'),
(308, 1, 'qwerty213', 'Login', '2025-11-30 12:26:22', '127.0.0.1'),
(309, 1, 'qwerty213', 'Login', '2025-11-30 13:04:42', '127.0.0.1'),
(310, 1, 'qwerty213', 'Logout', '2025-11-30 13:53:37', '127.0.0.1'),
(311, 20, 'pierce02', 'Logout', '2025-11-30 13:54:54', '127.0.0.1'),
(312, 1, 'qwerty213', 'Login', '2025-11-30 13:55:00', NULL),
(313, 1, 'qwerty213', 'Logout', '2025-11-30 13:55:49', '127.0.0.1'),
(314, 20, 'pierce02', 'Login', '2025-11-30 13:56:14', NULL),
(315, 20, 'pierce02', 'Logout', '2025-11-30 13:57:20', '127.0.0.1'),
(316, 1, 'qwerty213', 'Login', '2025-11-30 13:57:25', NULL),
(317, 1, 'qwerty213', 'Logout', '2025-11-30 13:57:32', '127.0.0.1'),
(318, 20, 'pierce02', 'Login', '2025-11-30 13:57:37', NULL),
(319, 20, 'pierce02', 'Logout', '2025-11-30 13:57:54', '127.0.0.1'),
(320, 1, 'qwerty213', 'Login', '2025-11-30 13:57:58', NULL),
(321, 1, 'qwerty213', 'Logout', '2025-11-30 14:30:43', '127.0.0.1'),
(322, 20, 'pierce02', 'Login', '2025-11-30 14:30:50', NULL),
(323, 20, 'pierce02', 'Logout', '2025-11-30 14:31:16', '127.0.0.1'),
(324, 1, 'qwerty213', 'Login', '2025-11-30 14:31:21', NULL),
(325, 1, 'qwerty213', 'Logout', '2025-11-30 14:34:11', '127.0.0.1'),
(326, 20, 'pierce02', 'Login', '2025-11-30 14:34:18', NULL),
(327, 20, 'pierce02', 'Logout', '2025-11-30 14:40:45', '127.0.0.1'),
(328, 1, 'qwerty213', 'Login', '2025-11-30 14:40:51', NULL),
(329, 1, 'qwerty213', 'Login', '2025-11-30 15:50:42', NULL),
(330, 1, 'qwerty213', 'Logout', '2025-11-30 16:06:00', '127.0.0.1'),
(331, 3, 'qwerty', 'Login', '2025-11-30 16:06:05', NULL),
(332, 3, 'qwerty', 'Logout', '2025-11-30 16:06:35', '127.0.0.1'),
(333, 1, 'qwerty213', 'Login', '2025-11-30 16:06:42', NULL),
(334, 1, 'qwerty213', 'Login', '2025-11-30 16:54:35', NULL),
(335, 1, 'qwerty213', 'Login', '2025-11-30 18:11:55', NULL),
(336, 20, 'pierce02', 'Login', '2025-11-30 18:35:11', NULL),
(337, 20, 'pierce02', 'Logout', '2025-11-30 18:35:24', '127.0.0.1'),
(338, 1, 'qwerty213', 'Login', '2025-11-30 18:35:29', NULL),
(339, 18, 'anne', 'Login', '2025-11-30 18:36:38', NULL),
(340, 18, 'anne', 'Logout', '2025-11-30 18:36:45', '127.0.0.1'),
(341, 14, 'harveyvaldez', 'Login', '2025-11-30 18:38:09', NULL),
(342, 1, 'qwerty213', 'Logout', '2025-11-30 20:25:13', '10.173.9.232'),
(343, 3, 'qwerty', 'Login', '2025-11-30 20:25:23', NULL),
(344, 3, 'qwerty', 'Logout', '2025-11-30 20:25:29', '10.173.9.232'),
(345, 1, 'qwerty213', 'Login', '2025-11-30 20:31:07', NULL),
(346, 1, 'qwerty213', 'Logout', '2025-11-30 20:31:29', '10.173.9.232'),
(347, 3, 'qwerty', 'Login', '2025-11-30 20:31:40', NULL),
(348, 1, 'qwerty213', 'Login', '2025-11-30 21:45:03', NULL),
(349, 1, 'qwerty213', 'Logout', '2025-11-30 21:47:41', '10.173.9.232'),
(350, 3, 'qwerty', 'Login', '2025-11-30 21:47:52', NULL),
(351, 3, 'qwerty', 'Logout', '2025-11-30 21:50:42', '10.173.9.232'),
(352, 20, 'pierce02', 'Login', '2025-11-30 21:50:54', NULL),
(353, 20, 'pierce02', 'Logout', '2025-11-30 21:50:58', '10.173.9.232'),
(354, 1, 'qwerty213', 'Login', '2025-11-30 21:51:15', NULL),
(355, 1, 'qwerty213', 'Logout', '2025-11-30 21:51:48', '10.173.9.232'),
(356, 1, 'qwerty213', 'Login', '2025-11-30 22:04:37', NULL),
(357, 1, 'qwerty213', 'Logout', '2025-11-30 22:04:57', '127.0.0.1'),
(358, 1, 'qwerty213', 'Login', '2025-12-01 08:34:11', NULL),
(359, 1, 'qwerty213', 'Logout', '2025-12-01 08:35:28', '127.0.0.1'),
(360, 21, 'asdfgh', 'Logout', '2025-12-01 08:35:42', '127.0.0.1'),
(361, 1, 'qwerty213', 'Login', '2025-12-01 08:35:46', NULL);
...
(21, 'Wmns Cortez', 10, 4171.98, 'hospitality-cruise-ship-management_1763377229.jpg', '2025-11-05 07:02:06', '10', 'US', 'Nike', 'Sneakers'),
(22, 'Vans Men\'s Old Skool', 3, 12312, 'vans.jpg', '2025-11-05 07:04:07', '10', 'EU', 'Vans', 'Sneakers'),
(28, 'high boots', 12, 1234, 'zac-wolff-esxf7PJmExQ-unsplash_1764057248.jpg', '2025-11-08 05:35:00', '12', 'EU', 'boots', 'Boots'),
...
(24, 105, 28, 'boots', 'name', 'boots', 'high boots', 'Name size stock', 3, 'qwerty', '2025-11-30 21:49:33'),
(25, 105, 28, 'boots', 'size', '10', '12', 'Name size stock', 3, 'qwerty', '2025-11-30 21:49:33'),
(26, 105, 28, 'boots', 'size_unit', 'UK', 'EU', 'Name size stock', 3, 'qwerty', '2025-11-30 21:49:33');

-- --------------------------------------------------------

--
-- Table structure for table `staff_setup_token`
--

DROP TABLE IF EXISTS `staff_setup_token`;
CREATE TABLE IF NOT EXISTS `staff_setup_token` (
  `id` int NOT NULL AUTO_INCREMENT,
  `token` varchar(100) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ix_staff_setup_token_token` (`token`),
  KEY `user_id` (`user_id`)
...
(6, 22, 'Vans Men\'s Old Skool', 3, 'Low Stock', '2025-11-30 16:08:41');
...
(20, 21, 'Wmns Cortez', 1, 11, 'Added 10 units', 1, 'qwerty213', '2025-11-30 13:59:24'),
(21, 22, 'Vans Men\'s Old Skool', 18, 3, 'Deducted 15 units', 1, 'qwerty213', '2025-11-30 16:08:41'),
(22, 21, 'Wmns Cortez', 11, 10, 'Deducted 1 units', 3, 'qwerty', '2025-11-30 21:48:06'),
(23, 28, 'boots', 11, 12, 'Added 1 units', 3, 'qwerty', '2025-11-30 21:48:17');
...
INSERT INTO `user` (`id`, `username`, `password`, `full_name`, `email`, `first_name`, `middle_name`, `last_name`, `birthdate`, `address`, `city`, `country`, `gender`, `education_level`, `terms_accepted`, `phone`, `department`, `is_active`, `created_at`, `role`, `is_approved`, `must_change_password`) VALUES
(1, 'qwerty213', '$2b$12$hxtfngLXVZrlC93xp6nZM.xj.UVOrPodO/m8AHUGcdTeGjvEKmSXK', 'System Administrator', 'admin@system.local', 'Pierce Harvey', 'Alea', 'Valdez', '2003-02-24', 'West rembo', 'makati', NULL, 'Male', 'College', 1, '09312311234', 'General', 1, '2025-11-16 06:39:20', 'admin', 1, 0),
(3, 'qwerty', '$2b$12$4NYurfl4D12E0r9lkjGNveieXuI9IExQjlILtJVWXAs1CihV0Q2N2', 'harvey pierce alea', 'harveyvaldez02@gmail.com', 'Harvey ', 'Pierce ', 'Alea', '2003-02-24', NULL, NULL, NULL, NULL, NULL, 0, '09159519433', 'General', 1, '2025-11-16 06:39:20', 'staff', 1, 0),
(12, 'anne213', '$2b$12$1uFu.KgR3Wlf37WJIn35aOiyNMhPbjkq8mNiLXkJZNP4erofnwAZG', 'anne quiatchon', 'annequiatchon23@gmail.com', 'Anne ', NULL, 'Quiatchon', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09956780716', 'General', 1, '2025-11-16 06:39:20', 'staff', 1, 0),
(14, 'harveyvaldez', '$2b$12$zbq6pA60VT..NK/TmUGH6umrsPnD24cMR0YyYQzbh5SUHDv1oLmCe', 'harvey valdez', 'harvey@gmail.com', 'Qwerty', NULL, 'Valdez', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09312315234', 'Inventory', 1, '2025-11-15 22:46:32', 'staff', 1, 0),
(15, 'glance21332', '$2b$12$h9F1/.w1/78GP3IdernHhO6UkpjJEFXpDEaD48yvIKvbN/kIbkllW', 'glance valdez', 'glance@gmail.com', 'Glance', NULL, 'Valdez', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09312315231', 'IT', 1, '2025-11-20 03:40:20', 'admin', 1, 0),
(16, 'piercevaldez02', '$2b$12$KcE8hX4ImyWvj2s7F.eYuutMPwJ7AN.vgh4AcOTIFoKl2BN8eZam6', 'Pierce Harvey Valdez', 'piercevaldez02@gmail.com', 'Pierce ', 'Harvey', 'Valdez', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09065630763', 'Inventory', 1, '2025-11-25 06:14:46', 'staff', 1, 0),
(17, 'glance24', '$2b$12$mB334zBSuWvaxPNimlOqYO88MOkOH3p510KjE47jI1y96geMu9oGK', 'Glance Erenest Valdez', 'harvey213@gmail.com', 'Glance ', 'Erenest ', 'Valdez', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09065645694', 'Inventory', 1, '2025-11-25 07:21:06', 'staff', 1, 0),
(18, 'anne', '$2b$12$6RUCHvqlb/roSn4tF3gdCOWa9OhkEV0/u1hkOBLaSTscs/R/QnWFO', 'Joie Anne Quiatchon', 'harvey2@gmail.com', 'Anne', 'Mascarinas', 'Quiatchon', '2003-06-01', '70 c panalo street cembo', 'Makati', NULL, 'Male', 'High School', 1, '09060229388', 'Inventory', 1, '2025-11-28 18:25:12', 'staff', 1, 0),
(20, 'pierce02', '$2b$12$aQUqIt2Vl.bm8rIZpBn6RugexQx5RujvCRijV2XzTIlmldmofnbIK', 'Piercy Harv Val', 'harveyvaldez14ph11ge@gmail.com', 'Pircy ', 'Harv ', 'Valdez', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09123456789', 'Sales', 1, '2025-11-30 13:53:06', 'staff', 1, 0),
(21, 'asdfgh', '$2b$12$fSgAMOyUm6Rf6SqOWh5iUeoVzvH80bGUec9E/b6WaCtNjGR.wXp2O', '', 'asdfgh@gmail.com', 'asdfgh', NULL, 'zxcvbn', NULL, NULL, NULL, NULL, NULL, NULL, 0, '09123456789', 'Inventory', 1, '2025-12-01 08:35:13', 'staff', 1, 1);
